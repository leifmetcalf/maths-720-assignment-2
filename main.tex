...
Since \(u\) and \(v\) are the commutators \([x,y]\) and \([x,y^{-1}]\) respectively, \(\frac G N\) is Abelian and hence a direct product of cyclic groups. It is also generated by two elements \(xN\) and \(yN\) of orders at most \(2\) and \(3\) respectively, so its order must be 1, 2, 3 or 6.
